...
final class Version20231214201642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE users_offer (users_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_CEA1237767B3B43D (users_id), INDEX IDX_CEA1237753C674EE (offer_id), PRIMARY KEY(users_id, offer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE users_offer ADD CONSTRAINT FK_CEA1237767B3B43D FOREIGN KEY (users_id) REFERENCES users (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE users_offer ADD CONSTRAINT FK_CEA1237753C674EE FOREIGN KEY (offer_id) REFERENCES offer (id) ON DELETE CASCADE');
