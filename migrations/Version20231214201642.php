...
final class Version20231214201642 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE _offer (user_id INT NOT NULL, offer_id INT NOT NULL, INDEX IDX_CEA1237767B3B43D (user_id), INDEX IDX_CEA1237753C674EE (offer_id), PRIMARY KEY(_id, offer_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
