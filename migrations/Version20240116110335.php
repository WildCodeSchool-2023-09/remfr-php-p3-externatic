 ...
 */
final class Version20240116110335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE criteria (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, salary INT DEFAULT NULL, profil VARCHAR(255) DEFAULT NULL, contract INT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, remote INT DEFAULT NULL, INDEX IDX_B61F9B81A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
